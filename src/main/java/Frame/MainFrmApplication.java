...
public class MainFrmApplication extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NW SCHOOL CONTACT APPLICATION");

        jButton1.setBackground(new java.awt.Color(204, 255, 255));
        jButton1.setForeground(new java.awt.Color(0, 204, 0));
        jButton1.setText("Cliquez ici pour créer de nouveaux contacts");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Redirection vers la creation d'un nouveau contact:
        MainFrmApplication.super.dispose();
        ContactcreateFRame but1= new ContactcreateFRame();
